//
//  main.c
//  veriyapilariodev4son
//
//  Created by Asude Ekiz on 11.05.2022.
//
//
//  main.c
//  assignment4vol3
...
EDGELIST addFile(EDGELIST spanlist){
    FILE *p =fopen("/Users/asude/Desktop/DÖNEM2/VERİ YAPILARI VE ALGORİTMALAR/veriyapilari ödev4/Sample_MST.txt", "r");
    int i = 0;
    char buffer[255];
    if(p != NULL){
