...
void Split_Data(data* holder,char buff[255],char delimiter[2]){
	char *token;
	// strtok(); Delim parametresi ile gosterilen karakter dizisi icindeki sõnõrlayõcõ karakterleri kullanarak str parametresi ile gosterilen karakter dizisini parcalara ayõrõr.
	token=strtok(buff,delimiter);
	// atoi(); Str parametresi ile gösterilen karakter dizisini int bir degere cevirir.
