...
public class MyPlayGround {
	...
	public void ilkelDuzenle( int x ) {
		x++; 
	}

	public void sarmalayiciDuzenle( Integer x ) {
		x++;
	}
	...
	public void sarmalayiciDegistirAlt(Integer x, Integer y) {
		Integer temp;
		temp = new Integer(x); x = new Integer(y);
		y = new Integer(temp);
		}
	...
	public static void main(String[] args) {
		MyPlayGround test = new MyPlayGround();
		test.tryMe();
	}
	...
	public void tryMe() {
	      ...
	      Integer wrap1 = 1;
	      Integer wrap2 = 2;
	      System.out.println("Before : " + wrap1 + ", " + wrap2 ); this.sarmalayiciDegistir(wrap1, wrap2); System.out.println("After: " + wrap1 + ", " + wrap2 );
	      System.out.println("Before : " + wrap1 + ", " + wrap2 ); this.sarmalayiciDegistirAlt(wrap1, wrap2); System.out.println("After: " + wrap1 + ", " + wrap2 );
	      wrapI = 3; wrapJ = 5;
	      System.out.println("Before : " + wrapI + ", " + wrapJ ); this.swapForReal();
